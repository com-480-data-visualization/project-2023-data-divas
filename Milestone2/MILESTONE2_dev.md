...
In the folder `./src/` are present the material needed for our initial [website](https://github.com/com-480-data-visualization/project-2023-data-divas/blob/dev/Milestone2/src/index.html) :
